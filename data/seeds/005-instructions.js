  ...
  return knex('instructions').truncate()
    .then(function () {
      ...
      return knex('instructions').insert([
        ...
        { recipe_id: 2, step_number: 2, instructions: "Toast bread" },
        { recipe_id: 2, step_number: 3, instructions: "Flip egg when the white parts are no longer translucent" },
        { recipe_id: 2, step_number: 4, instructions: "Take the egg out of the pan when it reaches your desired runniness" },
